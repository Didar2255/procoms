          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={12} md={6}>
              <Box>
                ...
                <Typography variant='body2' sx={{ my: 3 }}>We have built an extensive global network of brands and suppliers which enables us to source the latest fragrance at a great price ,which is the reason. We are able to keep our prices low.</Typography>
